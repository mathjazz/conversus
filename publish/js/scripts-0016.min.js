...
window.log=function(){log.history=log.history||[];log.history.push(arguments);arguments.callee=arguments.callee.caller;if(this.console){console.log(Array.prototype.slice.call(arguments))}};(function(e){function h(){}for(var g="assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profileEnd,time,timeEnd,trace,warn".split(","),f;f=g.pop();){e[f]=e[f]||h}})(window.console=window.console||{});$(function(){$("nav a").click(function(){$("nav a").removeClass("active");$(this).addClass("active")});$(".top").click(function(){$("nav a").removeClass("active");$("h1 a").addClass("active")});$('a:not(".email")').smoothScroll();$("#team li").hover(function(){$("#team img").removeClass("active");var a=$(this).find("img").addClass("active");$("#sodelavke .name").html(a.attr("alt"));$("#sodelavke .role").html(a.data("role"))},function(){})});